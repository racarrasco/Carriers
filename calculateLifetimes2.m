function[totalLifetime, tauRad, tauSRH,tauSRH2, tauAug] =...
    ...
    valenceEdge, conductionEdge,einf,Nc, Nv, ni, G, phi, a, b, c,...
...
valenceEdge, conductionEdge, defectLevel, defectDensity, dopingDensity, activation1);

% Shockley-Read-Hall lifetime for the doping level
tauSRH2 = ...
1e6.*shockleyReadHallLifetime(Tprobe, type, meStar, mhStar,Nc, Nv, ni,...
valenceEdge, conductionEdge, defectLevel2, defectDensity2, dopingDensity, activation2);
